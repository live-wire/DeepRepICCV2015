...
class RepDetector:
    ...
    # globals....    ....
        ...
        global global_counter, winner_stride, cur_state, in_frame_num, \
            actions_counter
...
if __name__ == '__main__':
    ...
    fromCam = True
    try:
        (opts, args) = getopt.getopt(sys.argv[1:], 'i:h:', ['ifile=',
                'help='])
    ...
    # display result on video................
        ...
        if cur_state == state.COOLDOWN and global_counter >= 5:
            ...
            print 'action %d: done. final counting: %d' \
                % (actions_counter, global_counter)
